...
import (
	...
	hyperp "github.com/hackafterdark/phosphor/pkg/agent/hyper"
...
type ConfigStore struct {
	...
	globalDataPath     string   // ~/.local/share/phosphor/phosphor.json
	workspacePath      string   // .phosphor/phosphor.json
