...
// fully detached from Phosphor's controlling terminal. This prevents shells
...
// It also prevents child processes from sending signals to Phosphor's process
// group.
...
// from Phosphor's session and controlling terminal.
//
