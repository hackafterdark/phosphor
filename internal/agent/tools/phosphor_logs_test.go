...
func TestNewPhosphorLogsTool(t *testing.T) {
	t.Parallel()
	tool := NewPhosphorLogsTool("/tmp/test.log")
	require.NotNil(t, tool)
	require.Equal(t, PhosphorLogsToolName, tool.Info().Name)
}

func TestPhosphorLogs_HappyPath(t *testing.T) {
	t.Parallel()
	...
	result := runPhosphorLogs(logFile, PhosphorLogsParams{Lines: 3})
...
func TestPhosphorLogs_DefaultLines(t *testing.T) {
	t.Parallel()
	...
	result := runPhosphorLogs(logFile, PhosphorLogsParams{Lines: 0})
...
func TestPhosphorLogs_MaxCap(t *testing.T) {
	t.Parallel()
	...
	result := runPhosphorLogs(logFile, PhosphorLogsParams{Lines: 200})

	lines := strings.Split(result, "\n")
	require.Len(t, lines, 100)
}

func TestPhosphorLogs_MissingFile(t *testing.T) {
	t.Parallel()
	result := runPhosphorLogs("/nonexistent/path/phosphor.log", PhosphorLogsParams{Lines: 50})
	require.Contains(t, result, "No log file found")
}

func TestPhosphorLogs_EmptyFile(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "phosphor.log")
...
func TestPhosphorLogs_MalformedLines(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "phosphor.log")
	...
	result := runPhosphorLogs(logFile, PhosphorLogsParams{Lines: 10})
...
func TestPhosphorLogs_ExtraFieldsSorted(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
	...
	result := runPhosphorLogs(logFile, PhosphorLogsParams{Lines: 1})
...
func TestPhosphorLogs_NonStringValues(t *testing.T) {
	t.Parallel()
	entry := map[string]any{
...
func TestPhosphorLogs_Redaction(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
...
func TestPhosphorLogs_ReservedFields(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
		{
			"time":   time.Now().Format(time.RFC3339),
...
func TestPhosphorLogs_OversizedLines(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "phosphor.log")
...
func TestPhosphorLogs_PartialTrailingLine(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "phosphor.log")
...
func TestPhosphorLogs_ValueQuoting(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
...
func TestPhosphorLogs_ChronologicalOrder(t *testing.T) {
	t.Parallel()
...
func TestPhosphorLogs_TimeOnlyFormat(t *testing.T) {
	t.Parallel()
	entry := map[string]any{
...
func TestPhosphorLogs_LevelVariations(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
	...
	result := runPhosphorLogs(logFile, PhosphorLogsParams{Lines: 5})
...
func TestPhosphorLogs_SourceVariations(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
