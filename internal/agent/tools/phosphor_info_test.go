...
func TestPhosphorInfo_MinimalConfig(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildPhosphorInfo(cfg, nil, nil, nil, nil)
...
func TestPhosphorInfo_ConfigFiles(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(
		&config.Config{Providers: csync.NewMap[string, config.ProviderConfig]()},
		"/home/user/.config/phosphor/phosphor.json",
		"/project/.phosphor/phosphor.json",
	)
	output := buildPhosphorInfo(cfg, nil, nil, nil, nil)
	require.Contains(t, output, "[config_files]")
	require.Contains(t, output, "/home/user/.config/phosphor/phosphor.json")
	require.Contains(t, output, "/project/.phosphor/phosphor.json")
}

func TestPhosphorInfo_Models(t *testing.T) {
	t.Parallel()
...
func TestPhosphorInfo_Providers(t *testing.T) {
	t.Parallel()
...
func TestPhosphorInfo_DisabledProvidersOmitted(t *testing.T) {
	t.Parallel()
...
func TestPhosphorInfo_LSPStates(t *testing.T) {
	t.Parallel()
	...
	output := buildPhosphorInfo(cfg, mgr, nil, nil, nil)
...
func TestPhosphorInfo_MCPStates(t *testing.T) {
	t.Parallel()
...
func TestPhosphorInfo_YoloMode(t *testing.T) {
	t.Parallel()
...
func TestPhosphorInfo_AllowedTools(t *testing.T) {
	t.Parallel()
...
func TestPhosphorInfo_DisabledTools(t *testing.T) {
	t.Parallel()
...
func TestPhosphorInfo_Options(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
		Options: &config.Options{
			DataDirectory:        "/Users/user/project/.phosphor",
			Debug:                true,
	...
	require.Contains(t, output, "data_directory = /Users/user/project/.phosphor")
	require.Contains(t, output, "debug = true")
}

func TestPhosphorInfo_AutoSummarizeInversion(t *testing.T) {
	t.Parallel()
	...
	outputFalse := buildPhosphorInfo(cfgFalse, nil, nil, nil, nil)
	...
	outputTrue := buildPhosphorInfo(cfgTrue, nil, nil, nil, nil)
	require.Contains(t, outputTrue, "auto_summarize = true")
}

func TestPhosphorInfo_NoSecrets(t *testing.T) {
	t.Parallel()
...
func TestPhosphorInfo_DeterministicOrdering(t *testing.T) {
	t.Parallel()
...
func TestPhosphorInfo_EmptySectionsOmitted(t *testing.T) {
	t.Parallel()
...
func TestPhosphorInfo_ConfigStaleness_Clean(t *testing.T) {
	t.Parallel()
	...
	output := buildPhosphorInfo(store, nil, nil, nil, nil)
...
func TestPhosphorInfo_ConfigStaleness_Dirty(t *testing.T) {
	t.Parallel()
...
func TestPhosphorInfo_ConfigStaleness_MissingPath(t *testing.T) {
	t.Parallel()
...
func TestPhosphorInfo_Skills_NoSkills(t *testing.T) {
	t.Parallel()
...
func TestPhosphorInfo_Skills_MixedLoadedUnloaded(t *testing.T) {
	t.Parallel()

	allSkills := []*skills.Skill{
		{Name: "go-doc", Builtin: false},
		{Name: "bash", Builtin: false},
		{Name: "phosphor-config", Builtin: true},
	}
	activeSkills := allSkills

	tracker := skills.NewTracker(activeSkills)
	tracker.MarkLoaded("bash")
	tracker.MarkLoaded("phosphor-config")

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildPhosphorInfo(cfg, nil, allSkills, activeSkills, tracker)
	require.Contains(t, output, "[skills]")
	require.Contains(t, output, "bash = user, loaded")
	require.Contains(t, output, "phosphor-config = builtin, loaded")
	require.Contains(t, output, "go-doc = user, unloaded")
}

func TestPhosphorInfo_Skills_DisabledSkills(t *testing.T) {
	t.Parallel()
	...
	require.Contains(t, output, "phosphor-config = builtin, unloaded")
	require.Contains(t, output, "image-convert = user, disabled")
}

func TestPhosphorInfo_Skills_Ordering(t *testing.T) {
	t.Parallel()
...
func TestPhosphorInfo_Skills_BuiltinOrigin(t *testing.T) {
	t.Parallel()
...
func TestPhosphorInfo_Hooks(t *testing.T) {
	t.Parallel()
...
func TestPhosphorInfo_Hooks_NoHooks(t *testing.T) {
	t.Parallel()
