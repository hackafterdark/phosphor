...
type ProviderConfig struct {
	...
	// When Models is empty and this is nil or true, Phosphor auto-discovers
...
type TUIOptions struct {
	...
	Theme       string `json:"theme,omitempty" jsonschema:"description=Name of built-in theme, theme file name, or path to a custom JSON/YAML theme file"`
...
type Attribution struct {
	...
	GeneratedWith bool         `json:"generated_with,omitempty" jsonschema:"description=Add Generated with Phosphor line to commit messages and issues and PRs,default=true"`
}
...
type Options struct {
	...
	DataDirectory             string       `json:"data_directory,omitempty" jsonschema:"description=Directory for storing application data. Relative paths are resolved against the working directory; absolute paths are used as-is.,default=.phosphor,example=.phosphor"`
	...
	InitializeAs              string       `json:"initialize_as,omitempty" jsonschema:"description=Name of the context file to create/update during project initialization,default=AGENTS.md,example=AGENTS.md,example=PHOSPHOR.md,example=CLAUDE.md,example=docs/LLMs.md"`
...
type Observability struct {
	...
	ServiceName string `json:"service_name,omitempty" jsonschema:"description=Service name for OTel resource,example=phosphor"`
...
// Config holds the configuration for phosphor.
type Config struct {
