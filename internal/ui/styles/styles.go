...
type Styles struct {
	...
	Header struct {
		...
		LogoGradCanvas    lipgloss.Style // Canvas for the compact "PHOSPHOR" gradient
		LogoGradFromColor color.Color    // "PHOSPHOR" wordmark gradient start
		LogoGradToColor   color.Color    // "PHOSPHOR" wordmark gradient end
	}
