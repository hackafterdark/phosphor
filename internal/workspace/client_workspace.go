...
func (w *ClientWorkspace) UpdateStateless(ctx context.Context, sessionID string, stateless bool, service string) error {
...
func (w *ClientWorkspace) AgentGenerateTitle(ctx context.Context, sessionID string) error {
	return w.client.AgentGenerateTitleSession(ctx, w.workspaceID(), sessionID)
}
...
func (w *ClientWorkspace) InitSystemAgent(ctx context.Context) error {
